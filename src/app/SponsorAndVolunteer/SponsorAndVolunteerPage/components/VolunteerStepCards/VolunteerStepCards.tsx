...
import type { VolunteerStep } from "../../hooks";

import { type Variants, motion } from "motion/react";

interface VolunteerStepCardsProps {
  steps: VolunteerStep[];
}

const VolunteerStepCards = ({ steps }: VolunteerStepCardsProps) => {
...
export default VolunteerStepCards;
