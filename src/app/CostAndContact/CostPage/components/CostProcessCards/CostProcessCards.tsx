...
import type { CostProcessStep } from "../../hooks";

import { type Variants, motion } from "motion/react";

interface CostProcessCardsProps {
  steps: CostProcessStep[];
}

const CostProcessCards = ({ steps }: CostProcessCardsProps) => {
...
export default CostProcessCards;
